...
#### getRAWCaptureZoomRatioRange^24+^
...
|类型|说明|
|:----------------------------------------------------------------------------------------------------------------------------|:---------------|
|Array\<[ZoomPointInfo](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-camera-i#zoompointinfo)\>|获取当前模式的等效焦距信息列表。|
